...
XList = xlsread('DATCOM_Inputs_Config1800000_ERIS300_01.xlsx','A2:A28');       % [m] - XList for DATCOM_Inputs_Config1800000_ERIS300_01.xlsx
RList = xlsread('DATCOM_Inputs_Config1800000_ERIS300_01.xlsx','B2:B28');       % [m] - RList for DATCOM_Inputs_Config1800000_ERIS300_01.xlsx
Discon = xlsread('DATCOM_Inputs_Config1800000_ERIS300_01.xlsx','C2:C6');       % [m] - Discon for DATCOM_Inputs_Config1800000_ERIS300_01.xlsx
LRef = xlsread('DATCOM_Inputs_Config1800000_ERIS300_01.xlsx','D2:D2');         % [m] - LRef for DATCOM_Inputs_Config1800000_ERIS300_01.xlsx
SRef = xlsread('DATCOM_Inputs_Config1800000_ERIS300_01.xlsx','E2:E2');         % [m^2] - SRef for DATCOM_Inputs_Config1800000_ERIS300_01.xlsx
...
AltList = xlsread('DATCOM_Inputs_Config1800000_ERIS300_01.xlsx','G2:G16');     % [m] - AltList for DATCOM_Inputs_Config1800000_ERIS300_01.xlsx
AoAList = xlsread('DATCOM_Inputs_Config1800000_ERIS300_01.xlsx','I2:I5');      % [Deg] - AoAList for DATCOM_Inputs_Config1800000_ERIS300_01.xlsx
XSeg = xlsread('DATCOM_Inputs_Config1800000_ERIS300_01.xlsx','H2:H12');        % [m] - Read in XSeg
...
ColNames = {'Altitude';'Mach';'AoA';'xi';'xi_center';'CA';'CN';'CM'};
ColUnits = {'meters' ;'-';'degrees';'meters';'meters';'-';'-';'-'};

filename = 'TEST01';             % File name for file to create
fid = fopen(filename, 'w+');     % Open file with write permissions
...
%%--------- Section 7: Save .mat file for plotting variables ------------%%
