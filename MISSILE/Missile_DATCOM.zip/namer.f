...
C
      CHARACTER*4 BLANK,EQUAL,COMMA,PARL,PARR,CARET,INUMS,
     1    KOL,INAME,IDIM,INLN,ICONST,KERR,
     2    KAND,VNAME,NLNAME
C
...
C
 1300 WRITE(IO,1420)
      STOP
C
 1310 FORMAT(8X,'*** NAMELIST INPUT ERROR.',
     1 ' ILLEGAL/INCORRECT SPECIFICATION OF NAMELIST NAME.',
     2 /,1X,80A1)
 1320 FORMAT(8X,'*** NAMELIST INPUT ERROR.',
     1 ' NO EQUALS FOLLOWING VARIABLE NAME.',/,1X,80A1)
 1330 FORMAT(8X,'*** NAMELIST INPUT ERROR.',
     1 ' NO CLOSING RIGHT PARENTHESIS IN ARRAY DEFINITION.',
     2 /,1X,80A1)
C1340 FORMAT(8X,'*** NAMELIST INPUT ERROR.',
C    1 ' NO TERMINATING COMMA OR'A1,' AFTER CONSTANT.',
C    2 ' A COMMA HAS BEEN ASSUMED.',/,1X,80A1)
 1350 FORMAT(8X,'*** NAMELIST INPUT ERROR.',
     1 ' VARIABLE NAME NOT IN NAMELIST.',/,1X,80A1)
 1360 FORMAT(8X,'*** NAMELIST INPUT ERROR.',
     1 ' ARRAY SUBSCRIPT OR NUMBER OF CONSTANTS EXCEEDS VARIABLE,',
     2 ' DIMENSION OR COMMON BLOCK SIZE.',/,1X,80A1)
 1370 FORMAT(8X,'*** NAMELIST INPUT ERROR.',
     1 ' ILLEGAL/INVALID ARRAY SUBSCRIPT.',/,1X,80A1)
 1380 FORMAT(8X,'*** NAMELIST INPUT ERROR.',
     1 ' REPEAT COUNT EXCEEDS VARIABLE ARRAY DIMENSION.',/,1X,80A1)
 1390 FORMAT(8X,'*** NAMELIST INPUT ERROR.',
     1 ' CONSTANT DOES NOT MATCH TYPE OF INPUT REQUIRED.',/,1X,80A1)
C1400 FORMAT(8X,'*** NAMELIST INPUT ERROR.'
C    1 ' REAL NUMBER SPECIFIED FOR INTEGER, CONVERTED.',/,1X,80A1)
 1410 FORMAT(1X,80A1)
 1420 FORMAT(8X,'*** EXECUTION TERMINATING DUE TO NAMELIST ERROR.')
C
      END
