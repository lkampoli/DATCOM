      SUBROUTINE MOMFOR(ALPHAR,BETAR,CNFLOW,CYFLOW)
C
C***********************************************************************
C
C     SUBROUTINE TO CALCULATE THE FORCE CODFFICIENT INCREMENT DUE TO
C     FLOW TURNING INTO THE INLET.
C
C***********************************************************************
C
...
C
      ...
      LOGICAL ICOVER
C
      AC = NIN*PI/4.*DEQI(2)**2.
C
      CNFLOW = 2.*AC*SIN(ALPHAR)/SREF
      CYFLOW = -2.*AC*SIN(BETAR)/SREF
C
      RETURN
      END
