      SUBROUTINE RELLB(LELLB, AA)
C
C***  READ ELLIPTICAL BODY INPUTS
C
      COMMON /CONST/  PI,RAD,UNUSED,KAND
C      
      CHARACTER*4 KAND,NLNAME,IVNAME
C
      DIMENSION AA(881),NLNAME(6),IVNAME(152),LEN(35),IDIM(35),LOC(35)
C
      LOGICAL LELLB,IEOF
C
...
C
      LELLB=.TRUE.
C
      CALL NAMER(KAND,2,NLNAME,6,IVNAME,152,LEN,35,IDIM,AA,881,LOC,IEOF)
C
      RETURN
      END
