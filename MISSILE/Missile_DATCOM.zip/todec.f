...
C**********************************************************************
C
C     INTEGER ALPHA,PLUS,PERIOD,EE,BLANK,POWER,SIGNP,PTEN,RVALUE
      INTEGER POWER,SIGNP,PTEN,RVALUE
      CHARACTER*4 NUM,PLUS,MINUS,PERIOD,EE,BLANK,ALPHA
C
...
C
         DO 1030 J=1,10
            IF(LVALUE .GT. 99999999)GO TO 1070
...
C
 1040    DO 1050 J=1,10
            IF(RVALUE .GT. 99999999)GO TO 1070
