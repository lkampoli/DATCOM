      SUBROUTINE RFLT(LFLT, AA)
C
C***  READ FLIGHT CONDITION INPUTS
C
      COMMON /CONST/ PI,RAD,UNUSED,KAND
C      
      CHARACTER*4 KAND,NLNAME,IVNAME
C
      DIMENSION AA(125),NLNAME(6),IVNAME(45),LEN(11),IDIM(11),LOC(11)
C
      LOGICAL LFLT,IEOF
C
...
C
      LFLT=.TRUE.
C
      CALL NAMER(KAND,2,NLNAME,6,IVNAME,45,LEN,11,IDIM,AA,144,LOC,IEOF)
C
      RETURN
      END
